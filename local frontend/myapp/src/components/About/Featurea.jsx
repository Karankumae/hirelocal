const iconRender = (val) => {
  ...
  const services = [
    {
      id: 1,
      title: "Affordable Local Talent",
      description:
        "Local freelancers provide top-quality work at affordable rates, helping businesses save money without compromising on quality.",
      icon: "default-ico",
    },
    {
      id: 2,
      ...
      description:
        "Being in the same city or region, local freelancers can deliver projects faster due to better communication and time zone alignment.",
      icon: "default-ico",
    },
    {
      id: 3,
      ...
      description:
        "Local freelancers understand your local market better and offer personalized support that aligns with your business needs.",
      icon: "default-ico",
    },
    {
      id: 4,
      ...
      description:
        "Hiring local freelancers supports your regional economy and helps independent professionals grow in your community.",
      icon: "default-ico",
    },
  ];
          ...
          <div className="flex flex-col space-y-16 px-5 sm:px-16 md:px-20 lg:px-28 py-8 bg-gray-100 dark:bg-gray-900">
            <div className="flex flex-col justify-center text-center mx-auto md:max-w-3xl space-y-5">
              ...
              <h1 className="text-3xl font-semibold text-blue-950 dark:text-white md:text-4xl xl:text-5xl leading-tight">
                Empowering Local Talent with Our Freelance Services
              </h1>
            </div>
