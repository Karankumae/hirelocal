...
const Herob = () => {
  ...
  Grow Faster with <span className="text-transparent bg-clip-text bg-gradient-to-br from-blue-600 from-20% via-indigo-400 via-30% to-teal-600">Skilled Local Freelancers</span> – Easy, Fast & Cost-Effective
</h1>

                        <p className="text-gray-700 dark:text-gray-300">
                        "Don't wait—partner with a local freelancer and watch your ideas come to life, faster and hassle-free."
                        </p>
                        <div className="mx-auto max-w-md sm:max-w-xl flex justify-center">
                            <Link href={'/SearchFreelancer'} className="outline-none h-12 px-5 rounded-xl bg-blue-600 text-white flex items-center">
