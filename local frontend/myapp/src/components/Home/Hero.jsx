  ...
  translate-y-[40%] -translate-x-[40%] bottom-0">
    ...
    <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
      <div className="text-center flex flex-col items-center space-y-10">
        ...
        Bring your ideas to life—hire a local freelancer 
        </h1>
        <p className="text-base text-gray-700 dark:text-gray-300 text-center max-w-xl">
        There are countless talented freelancers right in your city—offering better quality at lower rates! So why hire someone far away when the best talent is just around the corner? 
        </p>
        <div className="flex justify-center">
          <Link href="/Contact" className="px-8 h-12 rounded-full flex items-center gap-x-3 bg-emerald-700 text-white hover:bg-opacity-80">
            Be a Freelancer in HireLocal
            <span>
